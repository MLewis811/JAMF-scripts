...
| emptyGroups.py | Reads a list of device group names, and removes all devices from those groups (intended to prepare the groups for filling with assignUsersToDevices.py) | device_group |
